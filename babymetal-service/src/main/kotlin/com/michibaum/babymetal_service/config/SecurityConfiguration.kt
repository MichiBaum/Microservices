package com.michibaum.babymetal_service.config
            ...
            .authorizeHttpRequests { authorizeHttpRequests ->
                authorizeHttpRequests
                    ...
                    .requestMatchers(
                        "/actuator",
                        "/actuator/**"
                    ).hasAnyAuthority(Permissions.BABYMETAL_SERVICE.name)
                    .anyRequest().hasAnyAuthority(Permissions.BABYMETAL_SERVICE.name)
            }
