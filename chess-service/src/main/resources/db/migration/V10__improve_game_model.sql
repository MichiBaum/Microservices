...
ALTER TABLE game ADD COLUMN game_result ENUM('WHITE_WIN', 'BLACK_WIN', 'DRAW', 'ONGOING') NULL;
...
ALTER TABLE game ADD COLUMN imported_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE game ADD COLUMN fen VARCHAR(1024) NULL;
ALTER TABLE game ADD COLUMN round VARCHAR(255) NULL;
ALTER TABLE game ADD COLUMN board_number INT NULL;
...
ALTER TABLE game MODIFY game_result ENUM('WHITE_WIN', 'BLACK_WIN', 'DRAW', 'ONGOING') NOT NULL;
...
-- Modify player table
ALTER TABLE player MODIFY username VARCHAR(255) NULL;
