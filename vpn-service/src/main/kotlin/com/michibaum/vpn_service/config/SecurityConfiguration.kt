package com.michibaum.vpn_service.config
    ...
    fun securityFilterChain(
        ...
        return http
            .authorizeHttpRequests { authorizeHttpRequests ->
                authorizeHttpRequests
                    ...
                    .anyRequest().hasAnyAuthority(
                        Permissions.VPN_SERVICE_OWN_USER.name,
                        Permissions.VPN_SERVICE_ALL_USERS.name
                    )
            }
            ...
            .sessionManagement { sessionManagementSpec ->
                sessionManagementSpec.sessionCreationPolicy(SessionCreationPolicy.STATELESS)
            }
