    ...
    components: {
        ...
        progressspinner: {
            colorScheme: {
                light: {
                    root: {
                        color1: "{pink.500}", // TODO renamed from .1 to without .
                        color2: "{sky.500}", // TODO renamed from .2 to without .
                        color3: "{emerald.500}", // TODO renamed from .3 to without .
                        color4: "{amber.500}" // TODO renamed from .4 to without .
                    }
                },
                dark: {
                    root: {
                        color1: "{pink.400}", // TODO renamed from .1 to without .
                        color2: "{sky.400}", // TODO renamed from .2 to without .
                        color3: "{emerald.400}", // TODO renamed from .3 to without .
                        color4: "{amber.400}" // TODO renamed from .4 to without .
                    }
                }
            }
        },
